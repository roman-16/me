  ...
  return (
    <div {...props}>
      <div className="content is-medium">
        ...
        <br />
        To the surprise of my parents I always enjoyed spending much more time on my computer than working and helping at home.
        ...
        In high school I came for the first time in contact with programming (HTML, CSS) and it suited me really well.
